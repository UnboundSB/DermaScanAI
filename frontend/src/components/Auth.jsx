...
const Auth = ({ onAuthSuccess }) => {
  ...
  useEffect(() => {
    ...
    if (parseInt(calibrationValue) === TARGET_CALIBRATION) {
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className={`calibration-container ${isCalibrated ? 'calibrated-success' : ''}`}>
            ...
            <div className="calibration-header">
              ...
              <label className="calibration-label">
                ...
                {isCalibrated
                  ...
                  : `🎯 Calibrate focus engine to exactly ${TARGET_CALIBRATION}%`}
            ...
            <div className="slider-wrapper">
              ...
              <div className="slider-track">
                ...
                <div
                  ...
                  style={{ left: `${TARGET_CALIBRATION}%` }}

                >

                  <div className="marker-line" />

                  <div className="marker-label">{TARGET_CALIBRATION}%</div>
            ...
            {!isCalibrated && Math.abs(calibrationValue - TARGET_CALIBRATION) <= 5 && calibrationValue !== TARGET_CALIBRATION && (

              <div className="calibration-hint">

                {calibrationValue < TARGET_CALIBRATION ? 'Almost there! Go a bit higher →' : '← Close! Go a bit lower'}
